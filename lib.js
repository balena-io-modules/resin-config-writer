...
(function() {
  var CombinedStream, Promise, Stream, cp, es, fixedSizeStream, fs, getPartitionInfo, parseMBR;
  ...
  fixedSizeStream = require('./utils/stream').fixedSizeStream;
  ...
  exports.getContents = function(path, start, end) {
  ...
  exports.createPartitionStream = function(path, partitionNumber, data) {
    return getPartitionInfo(path, partitionNumber).then(function(partition) {
      var combinedStream;
      combinedStream = CombinedStream.create();
